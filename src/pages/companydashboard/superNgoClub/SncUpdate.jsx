  ...
  return (
    <>
      <CompanyLayout pageTitle={"SNC-Update"}>
        <h1 className='text-xl font-bold text-center my-2'>Update Super NGO Club Member</h1>
        <form className='w-full max-w-xl mx-auto  text-center mt-4  border-2 border-gray-400 rounded-lg bg-gray-200'>
          <div className='flex flex-wrap -mx-3 mb-6 p-5'>
            ...
            <div className="w-full">
              <button className='border rounded-xl bg-green-600 text-white px-3 py-1 hover:bg-green-800'>Update Membership</button>
            </div>
          </div>
        </form>
      </CompanyLayout>

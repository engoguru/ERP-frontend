...
//                   return (
//                     <tr key={lead._id} className="text-start">
...
// const seminar = ["mumbai seminar", "delhi seminar"];
...
//   useEffect(() => {
//     if (allowedSeminars.length > 0) {
//       setSelectedSeminar(allowedSeminars[0]);
//     }
//   }, [employeeData]);

//   // ✅ FETCH WITH FILTERS (UPDATED)
//   const fetchData = async (pageNumber = page, pageLimit = limit) => {
...
//         {/* ✅ Admin Seminar Selector */}
//         {isAdmin && (
//           <div className="mb-3">
//             <label className="mr-2 font-medium">Select Seminar:</label>
//             <select
//               className="border px-2 py-1 rounded"
//               value={selectedSeminar}
//               onChange={(e) => {
//                 setSelectedSeminar(e.target.value);
//                 setPage(1);
//               }}
//             >
//               {seminar.map((s) => (
...
//           </div>
//         </div>
//       {/* ✅ FILTER UI (TAILWIND SAFE) */}
//         <div className="grid grid-cols-2 md:grid-cols-3 gap-2 mb-3">
//           <input name="name" value={filters.name} onChange={handleChange} placeholder="Name" className="border px-2 py-1 rounded" />
//           <input name="contact" value={filters.contact} onChange={handleChange} placeholder="Contact" className="border px-2 py-1 rounded" />
//           <input name="city" value={filters.city} onChange={handleChange} placeholder="City" className="border px-2 py-1 rounded" />
//           <input name="state" value={filters.state} onChange={handleChange} placeholder="State" className="border px-2 py-1 rounded" />
//           <input name="email" value={filters.email} onChange={handleChange} placeholder="Email" className="border px-2 py-1 rounded" />
//           <input name="ngoName" value={filters.ngoName} onChange={handleChange} placeholder="NGO Name" className="border px-2 py-1 rounded" />
//         </div>
